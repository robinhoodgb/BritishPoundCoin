...
This mechanism has been integrated into Bitcore-Node-britishpound which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/britishpound-crypto/insight-api-britishpound#web-socket-api](https://github.com/britishpound-crypto/insight-api-britishpound#web-socket-api)
* API: [https://github.com/britishpound-crypto/insight-api-britishpound#swifttx-transactions](https://github.com/britishpound-crypto/insight-api-britishpound#swifttx-transactions)
...
By default, the britishpound Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the britishpound Core daemon:
