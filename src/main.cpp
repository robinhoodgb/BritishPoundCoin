...
#if defined(NDEBUG)
#error "britishpound cannot be compiled without assertions."
#endif
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
	...
	int64_t mNodeCoins = nMasternodeCount * 30000 * COIN;
...
{
    RenameThread("britishpound-scriptch");
