...
/** Utility functions used by the britishpound Qt UI.
 */
namespace GUIUtil
{
...
// Render britishpound addresses in monospace font
...
// Parse "britishpound:" URI into recipient object, return true on successful parsing
