...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("britishpound Core britishpound-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  britishpound-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded britishpound transaction") + "\n" +
                               "  britishpound-tx [options] -create [commands]   " + _("Create hex-encoded britishpound transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded britishpound transaction
