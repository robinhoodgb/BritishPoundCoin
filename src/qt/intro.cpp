...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
		...
		return false;
            ...
            try {
                ...
                QMessageBox::critical(0, tr("britishpound Core"),
     ...
     * override -datadir in the britishpound.conf file in the default data directory
     * (to be consistent with britishpoundd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
