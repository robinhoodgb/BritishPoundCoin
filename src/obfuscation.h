...
{
public:
    /// Is the inputs associated with this public key? (and there is 30000 GPBS - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of britishpound.
