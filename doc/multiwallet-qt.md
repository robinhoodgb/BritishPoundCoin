...
In order to support loading of multiple wallets in britishpound-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is britishpound.cpp.
...
Changes to britishpound.cpp
----------------------
britishpound.cpp is the entry point into britishpound-qt, and as such, will require some minor modifications to provide hooks for
