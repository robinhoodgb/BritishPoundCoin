...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop britishpound server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "britishpound server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"britishpound", "masternode", &masternode, true, true, false},
        {"britishpound", "listmasternodes", &listmasternodes, true, true, false},
        {"britishpound", "getmasternodecount", &getmasternodecount, true, true, false},
        {"britishpound", "masternodeconnect", &masternodeconnect, true, true, false},
        {"britishpound", "masternodecurrent", &masternodecurrent, true, true, false},
        {"britishpound", "masternodedebug", &masternodedebug, true, true, false},
        {"britishpound", "startmasternode", &startmasternode, true, true, false},
        {"britishpound", "createmasternodekey", &createmasternodekey, true, true, false},
        {"britishpound", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"britishpound", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"britishpound", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"britishpound", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"britishpound", "getmasternodescores", &getmasternodescores, true, true, false},
        {"britishpound", "mnbudget", &mnbudget, true, true, false},
        {"britishpound", "preparebudget", &preparebudget, true, true, false},
        {"britishpound", "submitbudget", &submitbudget, true, true, false},
        {"britishpound", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"britishpound", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"britishpound", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"britishpound", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"britishpound", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"britishpound", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"britishpound", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"britishpound", "checkbudgets", &checkbudgets, true, true, false},
        {"britishpound", "mnsync", &mnsync, true, true, false},
        {"britishpound", "spork", &spork, true, true, false},
        {"britishpound", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"britishpound", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use britishpoundd, or the -server option to britishpound-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> britishpound-cli " + methodname + " " + args + "\n";
}
