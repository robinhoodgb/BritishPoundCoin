                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BritishPound Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a britishpound address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and britishpound: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About britishpound Core"), this);
    aboutAction->setStatusTip(tr("Show information about britishpound Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for britishpound"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your britishpound addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified britishpound addresses"));
    ...
    openAction->setStatusTip(tr("Open a britishpound: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the britishpound Core help message to get a list with possible britishpound command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("britishpound Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to britishpound network", "", count));
}
...
{
    QString strTitle = tr("britishpound Core"); // default title
