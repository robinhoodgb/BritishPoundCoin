...
public:
    CMainParams()
    {
        ...
        nMaxMoneyOut = 66650000 * COIN; 

        const char* pszTimestamp = "britishpound cryptocurrency";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1623100741;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 9468933;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        assert(hashGenesisBlock == uint256("0x000003a0bc167ef0ce17d9379cc5f663a6adf4b4a91822ca6a96b3280513be71"));
        assert(genesis.hashMerkleRoot == uint256("0xb89509bee0c9916ca62a5bf024bc1fdd3effb5b6c09313e029c0ed7eeb545550"));

	vSeeds.push_back(CDNSSeedData("194.163.142.52","194.163.142.52"));  // Seed node 1		
...
public:
	...
	//removed testnet seeds. waiting for new addresses.
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet britishpound addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);  // Testnet britishpound script addresses start with '5' or '6'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet britishpound BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet britishpound BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet britishpound BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // britishpound: 1 day
        nTargetSpacing = 1 * 60;        // britishpound: 1 minutes
