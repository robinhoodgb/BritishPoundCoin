Contributing to britishpound Core
============================

The britishpound Core project operates an open contributor model where anyone is
...
The following applies to code changes to the britishpound Core project, and is not to be
confused with overall britishpound Network Protocol consensus changes.

Whether a pull request is merged into britishpound Core rests with the project merge
...
Patches that change britishpound consensus rules are considerably more involved than
...
Where a patch set proposes to change the britishpound consensus, it must have been
...
The project leader is the release manager for each britishpound Core release.
